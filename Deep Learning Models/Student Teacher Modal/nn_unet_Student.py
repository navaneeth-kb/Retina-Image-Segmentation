...
teacher_model.compile(optimizer=Adam(), loss=dice_loss,
...
def nn_unet(input_size=(256, 256, 1), num_classes=1, patch_size=None, depth=4, initial_filters=32):
